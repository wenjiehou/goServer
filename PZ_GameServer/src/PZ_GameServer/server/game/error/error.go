...
var (
	...
	ErrDiamondNotEnough          = &mjgame.ErrorItem{205, "房卡不足，请充值"}
	...
	ErrPlayHasNotEnoughDiamond   = &mjgame.ErrorItem{210, "玩家房卡不足"}
	...
	ErrInvalidReq                = &mjgame.ErrorItem{330, "你的请求太多了"}
	ErrBuchongCoin               = &mjgame.ErrorItem{340, "您的金币已不足，已为您补充20金币，祝您玩得开心！"}
)
